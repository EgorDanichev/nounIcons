...
import com.antonioleiva.mvpexample.app.main.Utils.Auth.TokenExpiredInterceptor;
import com.antonioleiva.mvpexample.app.main.Utils.XML.XmlInterceptor;
...
public class TranslateCommand {
    ...
    public void translate (String text) {
        ...
        service.translate("en",text,"Bearer "+ TokenStorage.getInstance().getToken()).enqueue(
