package com.antonioleiva.mvpexample.app.main.Utils.Auth;

import android.util.Log;

import com.antonioleiva.mvpexample.app.main.Utils.Auth.OAuth1.OauthConstants.ParameterList;
import com.antonioleiva.mvpexample.app.main.Utils.Auth.OAuth1.services.HMACSha1SignatureService;
import com.antonioleiva.mvpexample.app.main.Utils.Auth.OAuth1.services.TimestampServiceImpl;
...
public class OAuthInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        final String nonce = new com.antonioleiva.mvpexample.app.main.Utils.Auth.OAuth1.services.TimestampServiceImpl().getNonce();
